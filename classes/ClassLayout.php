...
class ClassLayout
{
    ...
    {
        $html = "<nav class='navbar col-12 position-fixed navbar-expand-lg navbar-dark bg-dark' style='z-index: 999;'>\n";
        ...
        $html .= "</li>\n";
        $html .= "<li class='nav-item'> \n";
        $html .= "<a class='nav-link' data-bs-toggle='modal' data-bs-target='#teste'>Link</a>\n";
        $html .= "  </li>\n";
    ...
    public static function setFooter()
    {
        ...
        $html="<footer class='page-footer font-small blue p-5' style='background-color: #333;'>\n";
